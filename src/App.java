                ...
                if (currentUser == null) {
                    ...
                    switch (choice) {
                        case "1": // Sign Up
                            ...
                            if (name.isEmpty() || email.isEmpty() || userId.isEmpty() ||
                                    password.length() < 8 || !UserStorage.isValidEmail(email)) {
                                System.out.println("Invalid input. Please check:");
                                System.out.println("- All fields required");
                                System.out.println("- Valid email format");
                                System.out.println("- Password ≥ 8 characters");
                                break;
                            }
                            ...
                            if (UserStorage.saveUser(email, password, name, userId)) {
                        ...
                        case "2": // Log In
                            ...
                            String storedUserId = UserStorage.validateLogin(loginEmail, loginPassword);
                            if (storedUserId != null) {
                                currentUser = storedUserId;
                                System.out.println("Welcome back, !");
                                // Initialize portfolio subject for this user
                    ...
                    switch (choice) {
                        case "1": // Add Asset
                            ...
                            CSVPortfolioSaver.savePortfolio(portfolioCtrl.viewPortfolio(currentUser), currentUser);
                            break;
                        case "2":
                            // case "2: Edit Asset "
